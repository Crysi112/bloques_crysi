...
figura_tcc(
    curvas=[
        ...
        ("51A Cab684 (80A, resp. 652)", i_plot, curva_51(r51A_684, i_plot), "teal", "solid", 2.5, True),
        ("51C Cab684 (90A, resp. 611)", i_plot, curva_51(r51C_684, i_plot), "navy", "solid", 2.5, True),
        ("51N Cab684 (90A)", i_plot, curva_51(r51N_684, i_plot), "cadetblue", "dash", 2.0, "legendonly"),
        ...
        ("CLF 100A @652 (aprox. T)", i_plot, curva_fusible(i_plot, 100.0), "dimgray", "dashdot", 2.5, "legendonly"),
