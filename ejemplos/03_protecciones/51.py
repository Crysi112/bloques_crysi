...
i_vals = np.linspace(pickup_51, i3ph * 1.2, 1000)
m = i_vals / pickup_51
t_51 = tms * (0.14 / (m**0.02 - 1))

plt.figure(figsize=(9, 6))
plt.loglog(i_vals, t_51, label=f'51 - IEC Standard Inverse (TMS = {tms:.3f})', color='blue', linewidth=2)
...
plt.title('Curva TCC - Función 51 (Tiempo Inverso)', fontsize=12, fontweight='bold')
